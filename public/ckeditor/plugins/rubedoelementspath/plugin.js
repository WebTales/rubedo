...
(function()
{
	...
	//emptyHtml = emptyHtml + '<span class="cke_button"><a id="cke_8" class="cke_off cke_button_save" "="" href="javascript:void('Enregistrer')" title="Enregistrer" tabindex="-1" hidefocus="true" role="button" aria-labelledby="cke_8_label" onkeydown="return CKEDITOR.tools.callFunction(4, event);" onfocus="return CKEDITOR.tools.callFunction(5, event);" onclick="CKEDITOR.tools.callFunction(6, this); return false;"><span class="cke_icon">&nbsp;</span><span id="cke_8_label" class="cke_label">Enregistrer</span></a></span>';

	CKEDITOR.plugins.add( 'rubedoelementspath',
	{
		requires : [ 'selection' ],
