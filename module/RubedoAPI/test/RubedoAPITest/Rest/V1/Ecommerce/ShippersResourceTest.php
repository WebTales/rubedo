...
use RubedoAPI\Rest\V1\Ecommerce\ShippersResource;

class ShippersResourceTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @var \RubedoAPI\Rest\V1\Ecommerce\ShippersResource
     */
    protected $resource;
    ...
    function setUp()
    {
        $this->resource = new ShippersResource();
    ...
    {
        $this->assertTrue($this->resource->getDefinition()->getVerb('get')->hasIdentityRequired());
    }
    ...
    public function testGetActionNotCountry()
    {
        ...
        $this->resource->getAction($params);
    }
