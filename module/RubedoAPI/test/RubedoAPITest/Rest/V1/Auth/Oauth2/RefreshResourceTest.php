...
use RubedoAPI\Rest\V1\Auth\Oauth2\RefreshResource;
...
class RefreshResourceTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var \RubedoAPI\Rest\V1\Auth\Oauth2\RefreshResource
     */
    protected $resource;
    ...
    function setUp()
    {
        $this->resource = new RefreshResource();
