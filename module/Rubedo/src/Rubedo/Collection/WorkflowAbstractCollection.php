...
abstract class WorkflowAbstractCollection extends AbstractLocalizableCollection implements IWorkflowAbstractCollection
{
     ...
     */
    public function getList(\WebTales\MongoFilters\IFilter $filters = null, $sort = null, $start = null, $limit = null, $live = true, $ismagic = null, $fingerPrint=null)
    {
        if ($live === true) {
            $this->_dataService->setLive();
        } else {
        ...
        $returnArray = parent::getList($filters, $sort, $start, $limit, $ismagic, $fingerPrint);
