...
class ContentsTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->_mockContentTypesService->expects($this->any())
            ->method('findById')
        ...
        $this->_mockWorkflowDataAccessService->expects($this->once())
            ->method('create')
            ->will($this->returnValue(array(
            'success' => true,
            'data' => array(
    ...
    public function testCreateWithBadConfigurationForAllowblankOnTextField()
    {
        ...
        $this->_mockWorkflowDataAccessService->expects($this->any())
            ->method('create')
            ->will($this->returnValue(array(
            'success' => true,
            'data' => array(
    ...
    public function testUpdateWithGoodConfigurationForAlphaVType()
    {
        ...
        $this->_mockCurrentUserService->expects($this->any())
    ...
    public function testDestroy()
    {
        ...
        $this->_mockDataIndexService->expects($this->once())
